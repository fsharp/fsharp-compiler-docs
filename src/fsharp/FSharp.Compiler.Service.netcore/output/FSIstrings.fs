...
type internal SR private() =
    ...
    static let resources = lazy (new System.Resources.ResourceManager("FSIstrings", TypeInThisAssembly(null).GetType().GetTypeInfo().Assembly))

#else
    static let resources = lazy (new System.Resources.ResourceManager("FSIstrings", System.Reflection.Assembly.GetExecutingAssembly()))
#endif
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:2)
    static member stoppedDueToError() = (GetStringFunc("stoppedDueToError",",,,") )
    /// Usage: %s <options> [script.fsx [<arguments>]]
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:3)
    static member fsiUsage(a0 : System.String) = (GetStringFunc("fsiUsage",",,,%s,,,") a0)
    /// - INPUT FILES -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:4)
    static member fsiInputFiles() = (GetStringFunc("fsiInputFiles",",,,") )
    /// - CODE GENERATION -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:5)
    static member fsiCodeGeneration() = (GetStringFunc("fsiCodeGeneration",",,,") )
    /// - ERRORS AND WARNINGS -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:6)
    static member fsiErrorsAndWarnings() = (GetStringFunc("fsiErrorsAndWarnings",",,,") )
    /// - LANGUAGE -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:7)
    static member fsiLanguage() = (GetStringFunc("fsiLanguage",",,,") )
    /// - MISCELLANEOUS -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:8)
    static member fsiMiscellaneous() = (GetStringFunc("fsiMiscellaneous",",,,") )
    /// - ADVANCED -
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:9)
    static member fsiAdvanced() = (GetStringFunc("fsiAdvanced",",,,") )
    /// Exception raised when starting remoting server.\n%s
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:10)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:11)
    static member fsiUse() = (GetStringFunc("fsiUse",",,,") )
    /// #load the given file on startup
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:12)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:13)
    static member fsiRemaining() = (GetStringFunc("fsiRemaining",",,,") )
    /// Display this usage message (Short form: -?)
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:14)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:21)
    static member fsiConsoleProblem() = (GetStringFunc("fsiConsoleProblem",",,,") )
    /// '%s' is not a valid assembly name
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:22)
    static member fsiInvalidAssembly(a0 : System.String) = (2301, GetStringFunc("fsiInvalidAssembly",",,,%s,,,") a0)
    /// Directory '%s' doesn't exist
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:23)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:24)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:25)
    static member fsiLineTooLong() = (GetStringFunc("fsiLineTooLong",",,,") )
    /// Real: %s, CPU: %s, GC %s
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:26)
    ...
    /// gen
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:27)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:28)
    static member fsiExceptionDuringPrettyPrinting(a0 : System.String) = (GetStringFunc("fsiExceptionDuringPrettyPrinting",",,,%s,,,") a0)
    ///   F# Interactive directives:
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:29)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:30)
    static member fsiIntroTextHashrInfo() = (GetStringFunc("fsiIntroTextHashrInfo",",,,") )
    /// Add the given search path for referenced DLLs
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:31)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:32)
    static member fsiIntroTextHashloadInfo() = (GetStringFunc("fsiIntroTextHashloadInfo",",,,") )
    /// Toggle timing on/off
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:33)
    static member fsiIntroTextHashtimeInfo() = (GetStringFunc("fsiIntroTextHashtimeInfo",",,,") )
    /// Display help
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:34)
    static member fsiIntroTextHashhelpInfo() = (GetStringFunc("fsiIntroTextHashhelpInfo",",,,") )
    /// Exit
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:35)
    static member fsiIntroTextHashquitInfo() = (GetStringFunc("fsiIntroTextHashquitInfo",",,,") )
    ///   F# Interactive command line options:
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:36)
    static member fsiIntroTextHeader2commandLine() = (GetStringFunc("fsiIntroTextHeader2commandLine",",,,") )
    ///       See '%s' for options
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:37)
    static member fsiIntroTextHeader3(a0 : System.String) = (GetStringFunc("fsiIntroTextHeader3",",,,%s,,,") a0)
    /// Loading
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:38)
    static member fsiLoadingFilesPrefixText() = (GetStringFunc("fsiLoadingFilesPrefixText",",,,") )
    /// \n- Interrupt\n
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:39)
    static member fsiInterrupt() = (GetStringFunc("fsiInterrupt",",,,") )
    /// \n- Exit...\n
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:40)
    static member fsiExit() = (GetStringFunc("fsiExit",",,,") )
    /// - Aborting main thread...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:41)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:42)
    static member fsiCouldNotInstallCtrlCHandler(a0 : System.String) = (GetStringFunc("fsiCouldNotInstallCtrlCHandler",",,,%s,,,") a0)
    /// --> Referenced '%s'
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:43)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:44)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:45)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:46)
    static member fsiDidAHashI(a0 : System.String) = (GetStringFunc("fsiDidAHashI",",,,%s,,,") a0)
    /// --> Timing now on
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:47)
    static member fsiTurnedTimingOn() = (GetStringFunc("fsiTurnedTimingOn",",,,") )
    /// --> Timing now off
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:48)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:49)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:50)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:51)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:52)
    ...
    /// (Originally from D:\Projects\visualfsharp\src\fsharp\fsi\FSIstrings.txt:53)
