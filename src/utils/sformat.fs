...
#if RUNTIME
#else
#if COMPILER || COMPILER_SERVICE  // FSharp.Compiler.dll: This is the PrintIntercepts extensibility point currently revealed by fsi.exe's AddPrinter
