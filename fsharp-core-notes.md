...
Reference documentation for FSharp.Core can be found here: [https://fsharp.github.io/fsharp-core-docs/](https://fsharp.github.io/fsharp-core-docs/)
...
Modern .NET development, including F#, uses SDK-style projects. You can read about that here: [https://learn.microsoft.com/dotnet/core/project-sdk/overview](https://learn.microsoft.com/dotnet/core/project-sdk/overview)
