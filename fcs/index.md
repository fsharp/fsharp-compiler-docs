...
The full current surface area can be seen at: [https://fsharp.github.io/fsharp-compiler-docs/reference/index.html](https://fsharp.github.io/fsharp-compiler-docs/reference/index.html)
